...
export class PermissionService {
    ...
    ): Observable<ApiResponse<Pagination<Permission>>> {
        return this.http.get<ApiResponse<Pagination<Permission>>>(
            this.baseUrl,
    ...
    update(
        ...
        return this.http.patch<ApiResponse<Permission>>(
            `${this.baseUrl}/${uuid}`,
            dto
        );
    }

...
export const ADMIN_ROUTES: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'create',
                loadComponent: () => import('./tours/tour-form/tour-form').then((m) => m.TourForm),
    ...
    },
    {
        ...
        children: [
            {
                path: '',
                loadComponent: () => import('./cities/city-list/city-list').then((m) => m.CityList),
            },
            {
                path: 'create',
                loadComponent: () => import('./cities/city-form/city-form').then((m) => m.CityForm),
                data: { breadcrumb: 'Create' },
            },
            {
                path: ':uuid',
                children: [
                    {
                        path: '',
                        loadComponent: () =>
                            import('./cities/city-detail/city-detail').then((m) => m.CityDetail),
                        data: { breadcrumb: 'Details' },
                    },
                    {
                        path: 'edit',
        ...
        children: [
            {
                path: '',
                loadComponent: () =>
                    import('./languages/language-list/language-list').then((m) => m.LanguageList),
            },
        ],
    },
    {
        ...
        children: [
            {
                path: '',
                loadComponent: () =>
                    import('./articles/article-list/article-list').then((m) => m.ArticleList),
            },
            {
                path: ':uuid',
                loadComponent: () =>
                    import('./articles/article-detail/article-detail').then((m) => m.ArticleDetail),
                data: { breadcrumb: 'Details' },
            },
        ],
    },
